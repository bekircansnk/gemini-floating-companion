...
4. **Google AI Studio 503 / 429 Aşımı**: `gemini-3.8-flash` yoğunluk anında 503 döndürdüğünde işlem iptal oluyordu. Çözüm: `GeminiVisionAnalyzer` içine `gemini-2.5-flash` ve `gemini-3.5-flash-lite` içeren otomatik failover zinciri eklendi.
